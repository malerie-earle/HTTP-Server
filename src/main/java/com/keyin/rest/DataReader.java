...
public class DataReader {
    ...
    public static List<City> loadCitiesFromJson(String jsonFilePath) throws IOException {
        return objectMapper.readValue(new File(jsonFilePath), new TypeReference<List<City>>() {});
    }
